...
--
-- Table structure for table `baidoxe`
--

DROP TABLE IF EXISTS `baidoxe`;
...
--
-- Dumping data for table `baidoxe`
--

LOCK TABLES `baidoxe` WRITE;
/*!40000 ALTER TABLE `baidoxe` DISABLE KEYS */;
/*!40000 ALTER TABLE `baidoxe` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `comment` (
  ...
  `id_baidoxe` int NOT NULL,
  PRIMARY KEY (`id`,`id_user`,`id_baidoxe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rating` (
  ...
  `id_user` int NOT NULL,
  `id_baidoxe` int NOT NULL,
  `stars` enum('1 star','1.5 stars','2 stars','2.5 stars','3 stars','3.5 stars','4 stars','4.5 stars','5 stars') DEFAULT NULL,
  PRIMARY KEY (`id`,`id_user`,`id_baidoxe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-10 22:02:03
